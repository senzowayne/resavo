...
class UserType extends AbstractType
{
    ...
    {
        $builder
            ->add('nom' ,null,['attr' => ['placeholder' => 'Entrez votre nom']])
            ->add('prenom' ,null,['attr' => ['placeholder' => 'Entrez votre prénom']])
            ...
            ->add('numero', null, ['attr' => ['placeholder' => 'ex: 0652....'],'label' => 'Numero de téléphone'])
